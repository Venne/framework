...
//			}
	...
	protected function createCompiler()
	{
		...
		$this->compiler
			->addExtension('venne', new \Venne\DI\Extensions\VenneExtension())
			->addExtension('console', new \Venne\DI\Extensions\ConsoleExtension())
			->addExtension('proxy', new \Venne\DI\Extensions\ProxyExtension());
